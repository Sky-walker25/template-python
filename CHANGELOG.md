...
### Changed
- Do not include devcontainer env by default
- Revert "fix(template): create .devcontainer/env.local when needed"


## [0.7.0] - 2026-05-19
Switch default user to rootless. No longer compatible with Docker.
...
### Fixed
- Create .devcontainer/env.local when needed


## [0.6.2] - 2026-05-12
Improve documentation, remove unused VS Code configuration entry.

### Added
- Add link to rendered template
- Add instruction for adapting existing project

### Removed
- Remove default interpreter path from devcontainer settings
